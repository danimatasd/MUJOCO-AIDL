...
# Uncoment if gpu is to be used
#device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

PROJECT = "AIDL-PPO-ANYMAL_C"
MUJOCO_STEPS = 5
...
def train_or_sweep(is_sweep=True):
    ...
    # Get number of imputs and actions
    n_inputs = 37
    n_actions = 12
    ...
    #policy = torch.load('./Policy_Reward_6036.56.pt.pt')
    #optimizer = torch.load('./Optimizer_Reward_6036.56.pt.pt')
...
#Uncoment the following to sweep the hyperparameters and fine tune and remember to coment the previous line!
